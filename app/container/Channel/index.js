...
export class Channel extends Component {
  ...
  renderSection() {
    let {
      channelRecommends: { data: videoBlocks = [] } = {},
      channelBanner: { data: swipers = [] } = {},
    } = this.props
    let sections = [
      { type: -1, data: [swipers], renderItem: this.renderSwiper.bind(this) },
      { type: -1, data: [channels], renderItem: this.renderMenu.bind(this) },
    ]
  ...
  render() {
    let { channelRecommends: { isRequesting } = {} } = this.props
