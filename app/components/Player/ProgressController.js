	...
	render() {
		...
		return (
			<View style={styles.view}>
				<TouchableOpacity style={{ padding: 0, justifyContent: "center", alignItems: "flex-start", width: 32, height: 32 }}
					onPress={this.onPlayOrPause.bind(this)}>
					{paused ?
						<Icon type="Feather" name="play-circle" /> :
						<Icon type="Feather" name="pause-circle" />
					}
				</TouchableOpacity>
